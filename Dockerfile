...
RUN mkdir /usr/local/lib/nodejs && \
    wget -nv https://nodejs.org/dist/v10.14.2/node-v10.14.2-linux-x64.tar.xz -O /usr/local/lib/nodejs/node-10.14.2-linux-x64.tar.xz && \
    tar -xJvf /usr/local/lib/nodejs/node-10.14.2-linux-x64.tar.xz -C /usr/local/lib/nodejs && \
    rm /usr/local/lib/nodejs/node-10.14.2-linux-x64.tar.xz && \
